...
public class VistaProcesadorPedidos extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VistaProcesadorPedidos
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaProcesadorPedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaProcesadorPedidos().setVisible(true);
            }
        });
    }
